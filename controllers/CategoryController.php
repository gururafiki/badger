...
class CategoryController extends AppController {
    ...
    public function actionView($col,$spo,$gen,$brand,$size,$type,$byprice){
        ...
        $button='<div class="right">
                    ...
                    <a href="/category/'.$col.'/'.$spo.'/'.$gen.'/'.$brand.'/'.$size.'/'.$type.'/0" title="" rel="nofollow">Популярности</a>         
                    <a href="/category/'.$col.'/'.$spo.'/'.$gen.'/'.$brand.'/'.$size.'/'.$type.'/1" title="" rel="nofollow">Цене</a>
                    <div class="clear"></div>
                </div>';
