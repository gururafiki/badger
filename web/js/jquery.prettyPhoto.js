...
(function($) {
	...
	$.fn.prettyPhoto = function(pp_settings) {
		pp_settings = jQuery.extend({
						...
						<div class="pp_content_container"> \
							...
							<div class="pp_right"> \
								<div class="pp_content"> \
									...
									<div class="pp_fade"> \
										<a class="pp_close" href="#" title="Закрыть">Закрыть</a> \
										<a href="#" class="pp_expand" title="Увеличить изображение">Увеличить</a> \
			...
			custom_markup: '',
			social_tools: '<div class="social_tools"></div>' /* html or false to disable */
		}, pp_settings);
		...
		*/
		function _showContent(){
			...
			$pp_pic_holder.animate({
				...
				settings.changepicturecallback(rel_index); // Callback!
				//settings.changepicturecallback.apply(element); // Callback!
