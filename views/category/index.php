...
<div id="menu" class="row-fluid hidden-sm hidden-xs">
    ...
    <div id="contents" class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
        <div id="content_text" class="">
            <div class="head">
                <div class="left">Добро пожаловать! 
                    <?php 
                ...
                <?php foreach ($Caps as $product): ?>
                    <div class="col-lg-4 col-sm-12 col-md-4 col-xs-12 content_bloks re-product-item folder1 per_row3">
                        ...
                        <div class="title" style="height: 65px;">
                            <a title="<?= $product->name ?>" href="<?= yii\helpers\Url::to(['product/view','id' => $product->id]) ?>" data-brand="Adidas"><?= $product->name ?> <?= $product->article ?></a>
                        </div>
                        ...
                        <div class="images-preview">
                            <a rel="prettyPhoto[gallery]" class="image-link" title="Увеличить изображение товара" data-href="<?= $product->photo ?>" data-title="<?= $product->name ?>" data-price="<?= $product->price_sell ?>" data-symbol="грн." href="<?= $product->photo ?>">
